...
const Index = () => {
  ...
  const prices = [
    { service: "Погрузка/разгрузка (1 час)", price: "от 700 ₽/час" },
    { service: "Квартирный переезд (бригада 2 чел)", price: "от 2900 ₽/час" },
    { service: "Сборка мебели", price: "от 800 ₽" },
    { service: "Упаковка/распаковка вещей", price: "от 700 ₽/час" },
